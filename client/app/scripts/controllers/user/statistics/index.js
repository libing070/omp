...
app.
controller('UserStatisticsCtrl', ["$scope", "$http", "$timeout", "$location", "serverUrl", "openCity","userAuth","httpUtils",function($scope, $http, $timeout, $location, serverUrl, openCity,userAuth,httpUtils) {
