...
Module.constant('datePickerConfig', {
  template: 'views/directive/datepicker.html',
  view: 'month',
...
Module.directive('datePicker', ['datePickerConfig', 'datePickerUtils', function datePickerDirective(datePickerConfig, datePickerUtils) {
  ...
  return {
    ...
    link: function (scope, element, attrs, ngModel) {
      //console.log("attrs")
      //console.log(typeof (attrs.clear))
      if(attrs.clear){
        if(attrs.clear=="true"){
          console.log(attrs.clear)
          scope.showDel=true;
        }else {
          scope.showDel=false;
        }
      ...
      if("hours"==attrs.view){//工作排期设置 时间日历 只有hours 去掉tab 特殊处理
    	  scope.isShowCurrTab1=false;
    	  scope.isShowCurrTab2=false;
      }else{
    	  scope.isShowCurrTab1=true;
    	  scope.isShowCurrTab2=true;
      }
